...
//            temp.delete();
   ...
   */
    ...
    */
    ...
    public String[] registerGitRepository(String username, String password, String proxyname, String giturl , String reponame) {
        ...
        if (userdao != null) {
            ...
            if (userlist != null && !userlist.isEmpty()) {
                User user = (User) userlist.get(0);
                //check double
                List<GitRepo> repos = repodao.findByProxyname(proxyname);
                if (repos.isEmpty()){
            ...
            if (userlist != null && !userlist.isEmpty()) {
                ...
                try{
                    ...
                    if (!repos.isEmpty()){
                        ...
                        for (int i = 0; i < repos.size(); i++) {
                            GitRepo gitrepo =  repos.get(i);
                            Util.replaceBlockWithSedForProxyGit(PROXY_GIT_FILE, gitrepo.getProxyname());
                        }
                        //delete them from the database
    ...
    @WebMethod
    public String[] deleteGitRepositoryFromUserByProxyname(String username, String password, String proxyname) {
        String[] res = {"1","Internal Server Error"};
        if (userdao != null) {
            List userlist =  userdao.findByUsernameAndPassword(username, password);
            if (userlist != null && !userlist.isEmpty()) {
